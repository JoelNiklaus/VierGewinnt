...
public class VierGewinnt {
	...
	public void play() {
		...
		if (opponent.equals("y"))
			...
			while ((1 != steps.length()) || (-1 == ("yn".indexOf(steps)))) {
				System.out
						.print("Can't understand your answer. Want to see all the steps of the game? (y / n) ");
	...
	/**
	 * simulates a game and determines the winner given the players (must be 2 computerplayers, no
	 * human players allowed!)
	 */
